export const ApiGateway = () => {
  return <svg viewBox="-27 0 310 310" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <g id="SVGRepo_iconCarrier">
      <g>
        <g transform="translate(153.000000, 46.000000)">
          ...
          <path d="M67.055,87.45 L103,91.042 L103,18.636 L67.055,0.661 L64.295,3.641 L64.295,84.369 L67.055,87.45"
                fill="#D9A740"></path>
        ...
        <g transform="translate(0.000000, 46.000000)">
          ...
          <path d="M35.945,87.45 L0,90.935 L0,18.31 L35.945,0.365 L37.6,3.456 L37.6,84.737 L35.945,87.45"
                fill="#886A2A"></path>
        ...
        <g transform="translate(153.000000, 171.000000)">
          ...
          <path d="M67.055,7.078 L103,3.486 L103,75.891 L67.055,93.866 L65.167,89.755 L65.167,10.772 L67.055,7.078"
                fill="#D9A740"></path>
        ...
        <g transform="translate(0.000000, 171.000000)">
          ...
          <path d="M35.945,7.078 L0,3.486 L0,75.891 L35.945,93.866 L38.124,90.626 L38.124,10.769 L35.945,7.078"
                fill="#886A2A"></path>
        ...
        <g transform="translate(55.000000, 0.000000)">
          <path d="M40.553,106.629 L73.519,100.848 L139.333,110.167 L145.002,113.428 L113.036,116.926 L40.553,106.629"
                fill="#634B1E"></path>
          <path d="M105.447,106.629 L72.481,100.848 L3.833,111.5 L0.998,113.428 L32.964,116.926 L105.447,106.629"
                fill="#634B1E"></path>
          <path d="M40.553,204.899 L73.519,210.68 L139.167,201.5 L145.002,198.1 L113.036,194.602 L40.553,204.899"
                fill="#FAD791"></path>
          <path d="M105.447,204.899 L72.481,210.68 L3.333,200.833 L0.998,198.1 L32.964,194.602 L105.447,204.899"
                fill="#FAD791"></path>
          <path
